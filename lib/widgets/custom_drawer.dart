...
class CustomDrawer extends StatelessWidget {
  ...
  List<DrawerItemsModel> items = [
    DrawerItemsModel(
        icon: "assets/img/new/7.png", name: "Running", rightIcon: ''),
    DrawerItemsModel(
        icon: "assets/img/new/20.png",
        name: "Yoga",
        rightIcon: 'assets/img/information.png'),
    DrawerItemsModel(
        icon: "assets/img/new/21.png", name: "Workout", rightIcon: ''),
    DrawerItemsModel(
        icon: "assets/img/new/22.png", name: "Walking", rightIcon: ''),
    DrawerItemsModel(
        icon: "assets/img/new/23.png",
        name: "Fitness",
        rightIcon: 'assets/img/information.png'),
    DrawerItemsModel(
        icon: "assets/img/new/24.png", name: "Strength", rightIcon: ''),
  ];
